...
const DashboardPage = () => {
  ...
  const navItems: Record<string, { id: string; label: string; icon: string }[]> = {
    ...
    stay_provider: [
      ...
      { id: "pricing", label: "Fees & Pricing", icon: "💳" },
      { id: "revenue", label: "Revenue", icon: "💰" },
      { id: "provider_config", label: "Provider Settings", icon: "🔧" },
      { id: "compliance", label: "Compliance", icon: "📋" },
      { id: "profile", label: "Profile", icon: "👤" },
    ],
    vehicle_provider: [
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex-1 p-6 md:p-8 pb-20 md:pb-8">
        ...
        {activeSection === "provider_config" && (currentUser === "stay_provider" || currentUser === "vehicle_provider" || currentUser === "event_organizer" || currentUser === "sme" || currentUser === "admin") && (
          <div className="max-w-6xl">
            <ProviderConfigDashboard />
          </div>
        )}
