...
const StaysPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-card border-b border-border py-3">
        <div className="container flex gap-2 items-center flex-wrap">
          ...
          <div className="ml-auto flex gap-2">
            {(profile?.role === "stay_provider" || profile?.role === "admin") && (
              <button onClick={() => setShowListModal(true)} className="px-4 py-1.5 rounded-full text-[13px] font-bold bg-sapphire/10 text-sapphire border border-sapphire hover:bg-sapphire/20 transition-all">➕ List Stay</button>
            )}
      ...
      <ListStayModal open={showListModal} onOpenChange={setShowListModal} />
